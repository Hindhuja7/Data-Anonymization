...
def detect_india_pii_column(
    ...
    if not all_matches:
        return {
            ...
            "reasoning": "No India-specific PII patterns detected in sample values",
            "column_name": column_name,
            "source": "regex"
        }
    ...
    return {
        ...
        "reasoning": f"Detected {most_common_pii_type} in {len(type_matches)} sample values using India-specific regex patterns",
        "column_name": column_name,
        "source": "regex"
    }
