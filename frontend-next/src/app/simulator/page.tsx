...
export default function SimulatorPage() {
  ...
  return (
    <div className="p-8 space-y-6">
      {/* Header */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white border border-slate-200 rounded-xl p-6 shadow-xl">
        <div>
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h1 className="text-xl font-bold text-slate-900 tracking-tight">Live Traffic Simulator</h1>
        ...
        <div className="flex items-center gap-2">
          {isListenerActive ? (
            <span className="text-xs px-3 py-1 rounded-full bg-emerald-50 text-emerald-600 border border-emerald-200 flex items-center gap-1.5 font-mono">
              <span className="w-2 h-2 rounded-full bg-emerald-500 animate-ping"></span>
              Live Sync Listener Active
            </span>
          ) : (
            <span className="text-xs px-3 py-1 rounded-full bg-slate-100 text-slate-500 border border-slate-200 flex items-center gap-1.5 font-mono">
      ...
      <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-xs text-slate-600">
          <div className="bg-slate-50 p-4 rounded-lg border border-slate-200 space-y-2">
            <div className="font-semibold text-cyan-600 flex items-center gap-1.5">
              <Database className="w-4 h-4 text-cyan-600" /> 1. Source DB Change (CRUD)
            </div>
          ...
          <div className="bg-slate-50 p-4 rounded-lg border border-slate-200 space-y-2">
            <div className="font-semibold text-amber-600 flex items-center gap-1.5">
              <RefreshCw className="w-4 h-4 text-amber-600" /> 2. 30s Change Detection
            </div>
            <p className="text-slate-500 leading-relaxed">
          ...
          <div className="bg-slate-50 p-4 rounded-lg border border-slate-200 space-y-2">
            <div className="font-semibold text-emerald-600 flex items-center gap-1.5">
              <ShieldCheck className="w-4 h-4 text-emerald-600" /> 3. Policy Anonymization
            </div>
            <p className="text-slate-500 leading-relaxed">
